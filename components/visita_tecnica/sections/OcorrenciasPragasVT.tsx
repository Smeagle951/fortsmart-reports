...
export default function OcorrenciasPragasVT({ pragas }: OcorrenciasPragasVTProps) {
    ...
    return (
        <section style={{ ...cardStyle, marginBottom: 24, overflow: 'hidden' }}>
            <div style={sectionTitleStyle}>Alertas Fitossanitários (Pragas, Doenças e Daninhas)</div>
            <div style={{ overflowX: 'auto' }}>
                <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 13, minWidth: 600 }}>
                    <thead>
                        <tr style={{ background: '#F8FAFC' }}>
                            <th style={{ padding: 14, textAlign: 'left', fontWeight: 700, color: '#475569', borderBottom: '2px solid #E2E8F0' }}>Classificação</th>
                            <th style={{ padding: 14, textAlign: 'left', fontWeight: 700, color: '#475569', borderBottom: '2px solid #E2E8F0' }}>Espécie / Alvo</th>
                            ...
                            <th style={{ padding: 14, textAlign: 'left', fontWeight: 700, color: '#475569', borderBottom: '2px solid #E2E8F0' }}>Status / LDE</th>
                        </tr>
                    </thead>
                    <tbody>
                        {pragas.map((p, i) => {
